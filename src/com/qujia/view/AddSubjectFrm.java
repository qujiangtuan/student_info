...
public class AddSubjectFrm extends JFrame {
          ...
          public AddSubjectFrm() {
                    ...
                    JButton btnNewButton = new JButton("\uAC1C  \uC124");
                                                                      ...
                                                                      .addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
                                                                                ...
                                                                                .addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
                                                                                          ...
                                                                                          .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                                                                                    .addComponent(comboBox_4, 0, 138, Short.MAX_VALUE)
                                                            ...
                                                            .addGroup(gl_contentPane.createSequentialGroup()
                                                                      .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                                                                .addGroup(gl_contentPane.createSequentialGroup()
                                                                                          ...
                                                                                          .addGap(18)
                                                                                          .addComponent(comboBox_1, 0, 122, Short.MAX_VALUE))
                                                                                .addGroup(gl_contentPane.createSequentialGroup()
                                                                                          .addComponent(lblNewLabel_3)
                                                                                          .addPreferredGap(ComponentPlacement.UNRELATED)
                                                                                          .addComponent(comboBox_3, 0, 124, Short.MAX_VALUE))
                                                                                .addGroup(gl_contentPane.createSequentialGroup()
                                                                                          .addComponent(lblNewLabel_5)
                                                                                          .addPreferredGap(ComponentPlacement.UNRELATED)
                                                                                          .addComponent(comboBox_5, 0, 124, Short.MAX_VALUE))
                                                                                .addGroup(gl_contentPane.createSequentialGroup()
