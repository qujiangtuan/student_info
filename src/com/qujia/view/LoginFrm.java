...
public class LoginFrm extends JFrame {
	...
	public LoginFrm() {
	          ...
	          setIconImage(Toolkit.getDefaultToolkit().getImage(LoginFrm.class.getResource("/images/student1.png")));
		setTitle("학사관리시스템");
		...
		label.setIcon(new ImageIcon(LoginFrm.class.getResource("/images/student2.png")));
		label.setFont(new Font("NanumMyeongjo", Font.BOLD, 18));
		
		JLabel userNameLabel_1 = new JLabel(" 아 이 디 :");
		userNameLabel_1.setIcon(new ImageIcon(LoginFrm.class.getResource("/images/username.png")));
		userNameLabel_1.setFont(new Font("NanumMyeongjo", Font.BOLD, 13));
		
		userNameTextField = new JTextField();
		userNameTextField.setColumns(10);
		
		JLabel passwordLabel = new JLabel("비밀번호：");
		passwordLabel.setIcon(new ImageIcon(LoginFrm.class.getResource("/images/password.png")));
		passwordLabel.setFont(new Font("NanumMyeongjo", Font.BOLD, 13));
		...
		userTypeLabel.setFont(new Font("NanumMyeongjo", Font.BOLD, 13));
		
		userTypeComboBox = new JComboBox();
		userTypeComboBox.setModel(new DefaultComboBoxModel(new UserType[] {UserType.STUDENT,UserType.TEACHER,UserType.ADMIN}));
		userTypeComboBox.setFont(new Font("NanumMyeongjo", Font.BOLD, 13));
	...
	protected void loginAction(ActionEvent ae) {
                   ...
                   if(StringUtil.isEmpty(userName)){
                             JOptionPane.showMessageDialog(this,"사용자 이름은 비워 둘 수 없습니다！");
                             return;
                   }
                   if(StringUtil.isEmpty(password)){
                             JOptionPane.showMessageDialog(this,"비밀번호는 비워 둘 수 없습니다.！");
                             return;
                   }
                   Admin admin = null;
                   if("관리자".equals(selectedItem.getName())){
                             ...
                             JOptionPane.showMessageDialog(this, "【"+selectedItem.getName()+"】："+admin.getName()+" , 환영합니다 !");
                             this.dispose();
