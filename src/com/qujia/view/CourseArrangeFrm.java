...
public class CourseArrangeFrm extends JFrame {
          ...
          private  JComboBox comboBox_1,comboBox_2,comboBox_3,comboBox_4,comboBox_5,comboBox_6,comboBox_7;
          ...
          public CourseArrangeFrm() {
                    ...
                    comboBox_schYear.setModel(new DefaultComboBoxModel(new String[] {"1", "2", "3", "4", "대학원1", "대학원2", "대학원3"}));
                    
                    leabel_term = new JLabel("\uB204\uC801\uD559\uAE30:");
...
//                                        JCheckBox[] checkBox={null,checkBox_1,checkBox_2,checkBox_3,checkBox_4,checkBox_5,checkBox_6,checkBox_7};
////                                        JSpinner[][] spinner={ {spinner_1_1,spinner_2_1,spinner_3_1,spinner_4_1,spinner_5_1,spinner_6_1,spinner_7_1}, 
////                                                            {spinner_1_2,spinner_2_2,spinner_3_2,spinner_4_1,spinner_5_2,spinner_6_2,spinner_7_2}};
//                                        JSpinner[][] spinner={ {spinner_1_1,spinner_1_2},{spinner_2_1,spinner_2_2},{spinner_3_1,spinner_3_2},{spinner_4_1,spinner_4_1},
...
//                                                            dateStart[i]=dux.Date2String((Date) spinner[i][j].getValue());
//                                                            dateEnd[i]=dux.Date2String((Date) spinner[i][j].getValue());
//                                                            className[i] = comboBox[i].getSelectedItem().toString();
...
//                                                            tt[i].setCr(cr[i]);
//                                                            map[i] =new HashMap<Integer, Object>();
...
//                                        }
                                        ...
                                        String className1 = comboBox_1.getSelectedItem().toString();
                                        ...
                                        String className2 = comboBox_2.getSelectedItem().toString();
                                        ...
                                        String className3 = comboBox_3.getSelectedItem().toString();
                                      ...
                                      //4
                                        ...
                                        String className4 = comboBox_4.getSelectedItem().toString();
                                      ...
                                      //5
                                        ...
                                        String className5 = comboBox_5.getSelectedItem().toString();
                                        ...
                                        String className6 = comboBox_6.getSelectedItem().toString();
...
//                    SpinnerDateModel model = new SpinnerDateModel();
                    ...
                    //spinner_1_1.setModel(new SpinnerDateModel(new Date(1536505200000L), new Date(1536505200000L), new Date(1536505200000L), Calendar.HOUR));
                    ...
                    //spinner_1_2.setModel(new SpinnerDateModel(new Date(1536505200000L), new Date(1536505200000L), new Date(1536505200000L), Calendar.HOUR));
                    ...
                    this.setMyModel(spinner_7_2);
                      ...
                      comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"2001", "2002", "2003", "2004"}));
                    
                      comboBox_2 = new JComboBox();
                      comboBox_2.setModel(new DefaultComboBoxModel(new String[] {"2001", "2002", "2003", "2004"}));
                    
                      comboBox_3 = new JComboBox();
                      comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"2001", "2002", "2003", "2004"}));
                    
                      comboBox_4 = new JComboBox();
                      comboBox_4.setModel(new DefaultComboBoxModel(new String[] {"2001", "2002", "2003", "2004"}));
                    
                      comboBox_5 = new JComboBox();
                      comboBox_5.setModel(new DefaultComboBoxModel(new String[] {"2001", "2002", "2003", "2004"}));
                    
                      comboBox_6 = new JComboBox();
                      comboBox_6.setModel(new DefaultComboBoxModel(new String[] {"2001", "2002", "2003", "2004"}));
                    
                      comboBox_7 = new JComboBox();
                      comboBox_7.setModel(new DefaultComboBoxModel(new String[] {"2001", "2002", "2003", "2004"}));
                                                                                ...
                                                                                .addGroup(gl_contentPane.createSequentialGroup()
                                                                                          .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                                                                                    .addGroup(gl_contentPane.createSequentialGroup()
                                                                                                              ...
                                                                                                              .addComponent(comboBox_name, GroupLayout.PREFERRED_SIZE, 158, GroupLayout.PREFERRED_SIZE))
                                                                                                    .addGroup(gl_contentPane.createSequentialGroup()
                                                                                                              .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                                                                                              ...
                                                                                                              .addPreferredGap(ComponentPlacement.UNRELATED)
                                                                                                              .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                                                                                                        .addComponent(comboBox_schYear, 0, 158, Short.MAX_VALUE)
                                                                                                                        .addComponent(comboBox_pro, 0, 158, Short.MAX_VALUE))))
                                                                                          .addGap(34)
                                                                                          .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                                                                                    .addGroup(gl_contentPane.createSequentialGroup()
                                                                                                              .addGap(23)
                                                                                                              ...
                                                                                                              .addPreferredGap(ComponentPlacement.UNRELATED)
                                                                                                              .addComponent(textField_no, GroupLayout.PREFERRED_SIZE, 161, GroupLayout.PREFERRED_SIZE))
                                                                                                    .addGroup(gl_contentPane.createSequentialGroup()
                                                                                                              ...
                                                                                                              .addPreferredGap(ComponentPlacement.UNRELATED)
                                                                                                              .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
                                                                                                                        .addComponent(comboBox_term, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                                                                                        .addComponent(datePicker_date, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))))
                                                                      .addGap(63))))
                    );
                                        ...
                                        .addGroup(gl_contentPane.createSequentialGroup()
                                                  ...
                                                  .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                                            .addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
                                                                      ...
                                                                      .addComponent(leabel_date))
                                                            .addComponent(datePicker_date, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                                                  .addGap(18)
                                                  .addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
                                                            .addComponent(leabel_schYear)
                                                            .addComponent(leabel_term)
