                                                  ...
                                                  .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                                            .addGroup(gl_contentPane.createSequentialGroup()
                                                                      ...
                                                                      .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                                                                ...
                                                                                .addComponent(comboBox_2, Alignment.TRAILING, 0, 204, Short.MAX_VALUE)
                                                                                .addComponent(comboBox_3, Alignment.TRAILING, 0, 204, Short.MAX_VALUE)
                                                            ...
                                                            .addGroup(gl_contentPane.createSequentialGroup()
                                                                      .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                                                                ...
                                                                                .addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 818, Short.MAX_VALUE))
                                                                      .addContainerGap())))
                    );
