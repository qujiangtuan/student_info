...
//                    vu.showCenter(this);
                    ...
                    classNameLabel.setIcon(new ImageIcon(DeptManagerFrm.class.getResource("/images/className.png")));
                    ...
                    searchButton.setIcon(new ImageIcon(DeptManagerFrm.class.getResource("/images/search.png")));
                    ...
                    btnNewButton.setFont(new Font("NanumMyeongjo", Font.BOLD, 14));
                    
                    JButton btnNewButton_1 = new JButton("삭  제\r\n");
                    btnNewButton_1.setBackground(new Color(255, 140, 0));
                    btnNewButton_1.setFont(new Font("NanumMyeongjo", Font.BOLD, 14));
                    ...
                    classListTable.getColumnModel().getColumn(1).setPreferredWidth(112);
                    classListTable.getColumnModel().getColumn(2).setPreferredWidth(81);
                    classListTable.getColumnModel().getColumn(3).setPreferredWidth(95);
                    classListTable.getColumnModel().getColumn(4).setPreferredWidth(79);
                    classListTable.getColumnModel().getColumn(5).setPreferredWidth(108);
                    classListTable.getColumnModel().getColumn(6).setPreferredWidth(133);
                    classListTable.getColumnModel().getColumn(7).setPreferredWidth(93);
                    classListTable.getColumnModel().getColumn(8).setPreferredWidth(88);
                    classListTable.getColumnModel().getColumn(9).setPreferredWidth(129);
